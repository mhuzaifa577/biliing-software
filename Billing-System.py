...
class Bill_App:
    def __init__(self,root):
        ...
        #=======================================snacks label frame=================================================================
        snacks=LabelFrame(self.root,text="books",font=("Arial Black",12),bg="#E5B4F3",fg="#6C3483",relief=GROOVE,bd=10)
        ...
        button_print=Button(button_frame,text="Exit",font=("Arial Black",15),pady=10,bg="#E5B4F3",fg="#6C3483",width=8,command=lambda:exit(self)).grid(row=0,column=2,padx=10,pady=6)
def print_file():
    ...
    if file_to_print:
        ...
        root.ShellExecute(0, "print", file_to_print, None, ".", 0)
...
def intro(self):
    ...
    self.txtarea.insert(END,"\tWELCOME TO NEW AL HIJRA\n\tPhone-No.739275410")
